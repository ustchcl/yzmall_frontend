...
(function(exports) {
  ...
  var prop = function (dictIsProp) {
      return function (v) {
          return function ($36) {
              return Halogen_VDom_DOM_Prop.Property.create(v)(toPropValue(dictIsProp)($36));
          };
      };
  };       
  ...
  exports["semigroupClassName"] = semigroupClassName;
...
(function(exports) {
  ...
  var CommodityInfo = (function () {
      function CommodityInfo(value0) {
          this.value0 = value0;
      };
      CommodityInfo.create = function (value0) {
          return new CommodityInfo(value0);
      };
  ...
  var AboutUs = (function () {
      ...
      AboutUs.value = new AboutUs();
      return AboutUs;
  })();
  var ReturnPolicy = (function () {
      function ReturnPolicy() {

      };
      ReturnPolicy.value = new ReturnPolicy();
      return ReturnPolicy;
  })();
  var TradeCenter = (function () {
      function TradeCenter() {

      };
      TradeCenter.value = new TradeCenter();
      return TradeCenter;
  })();
  var WDTG_ROUTE = (function () {
      function WDTG_ROUTE() {

      };
      WDTG_ROUTE.value = new WDTG_ROUTE();
      return WDTG_ROUTE;
  })();
  var WDDS_ROUTE = (function () {
      function WDDS_ROUTE() {

      };
      WDDS_ROUTE.value = new WDDS_ROUTE();
      return WDDS_ROUTE;
  })();
  var WDFX_ROUTE = (function () {
      function WDFX_ROUTE() {
  ...
  var testSlug = Data_Maybe.fromJust()(Slug.generate("sss-sss"));
  ...
  var eqRoute = new Data_Eq.Eq(function (x) {
      return function (y) {
          ...
          if (x instanceof ReturnPolicy && y instanceof ReturnPolicy) {
              return true;
          };
          if (x instanceof TradeCenter && y instanceof TradeCenter) {
              return true;
          };
          if (x instanceof WDTG_ROUTE && y instanceof WDTG_ROUTE) {
              return true;
          };
          if (x instanceof WDDS_ROUTE && y instanceof WDDS_ROUTE) {
              return true;
          };
...
(function(exports) {
  ...
  exports["alignContentBetween"] = alignContentBetween;
  ...
  exports["carouselControlNext"] = carouselControlNext;
  exports["carouselControlNextIcon"] = carouselControlNextIcon;
  exports["carouselControlPrev"] = carouselControlPrev;
  exports["carouselControlPrevIcon"] = carouselControlPrevIcon;
  ...
  exports["navbarExpandMd"] = navbarExpandMd;
...
(function(exports) {
  ...
  var c105Info = "http://xiangqingkeji.com/systema/kindeditor-4.1.10/attached/image/20190309/20190309185705_26138.jpg";
...
(function(exports) {
  ...
  exports["parse"] = parse;
})(PS["Yzmall.Data.Avatar"] = PS["Yzmall.Data.Avatar"] || {});
(function(exports) {
  // Generated by purs version 0.12.1
  "use strict";
  var Data_Eq = PS["Data.Eq"];
  ...
  var forkData = {
      ...
      onSale: true,
      recommend: true,
      thumbnial: Data_Maybe.Nothing.value,
      picture: Data_Maybe.Nothing.value
  };
  var eqCommodityCategory = new Data_Eq.Eq(function (x) {
      return function (y) {
  ...
  exports["eqCommodityCategory"] = eqCommodityCategory;
...
(function(exports) {
  ...
  var attr_ = function (key) {
      return function (value) {
          return Halogen_HTML_Properties.attr(key)(value);
      };
  };
...
(function(exports) {
  // Generated by purs version 0.12.1
  "use strict";
  var $foreign = PS["Yzmall.Api.Request"];
...
(function(exports) {
  ...
  exports["nowTime"] = nowTime;
  exports["Now"] = Now;
})(PS["Yzmall.Capability.Now"] = PS["Yzmall.Capability.Now"] || {});
(function(exports) {
  // Generated by purs version 0.12.1
  "use strict";
  var Control_Applicative = PS["Control.Applicative"];
  ...
  var nowAppM = new Yzmall_Capability_Now.Now(function () {
      return monadAppM;
  ...
  var navigateAppM = new Yzmall_Capability_Navigate.Navigate(function () {
      return monadAppM;
  }, Control_Bind.discard(Control_Bind.discardUnit)(bindAppM)(Control_Bind.bindFlipped(bindAppM)(function ($13) {
      return Effect_Class.liftEffect(monadEffectAppM)(Effect_Ref.write(Data_Maybe.Nothing.value)($13));
      ...
      return Effect_Class.liftEffect(monadEffectAppM)(Routing_Hash.setHash(Routing_Duplex.print(Yzmall_Data_Route.routeCodec)($14)));
  });
  exports["Dev"] = Dev;
  exports["AppM"] = AppM;
...
})(PS["Yzmall.Page.Part.Login"] = PS["Yzmall.Page.Part.Login"] || {});
(function(exports) {
  // Generated by purs version 0.12.1
  "use strict";
  var Data_Function = PS["Data.Function"];
...
})(PS["Yzmall.Page.Part.MobileMenu"] = PS["Yzmall.Page.Part.MobileMenu"] || {});
(function(exports) {
  // Generated by purs version 0.12.1
  "use strict";
  var Conduit_Component_Utils = PS["Conduit.Component.Utils"];
...
(function(exports) {
  ...
  exports["component"] = component;
})(PS["Yzmall.Page.CommodityInfo"] = PS["Yzmall.Page.CommodityInfo"] || {});
(function(exports) {
  // Generated by purs version 0.12.1
  "use strict";
  var Control_Applicative = PS["Control.Applicative"];
...
(function(exports) {
              ...
              return function (dictNavigate) {
                  var render = function (v) {
                      if (v.route instanceof Yzmall_Data_Route.RegularCommodity) {
                          return Halogen_HTML["slot'"](Halogen_Component_ChildPath.cp1)(Data_Unit.unit)(Yzmall_Page_Commodity.component)(Data_Unit.unit)(Data_Void.absurd);
                      };
                      ...
                      if (v.route instanceof Yzmall_Data_Route.CommodityInfo) {
                          return Halogen_HTML["slot'"](Halogen_Component_ChildPath.cp3)(Data_Unit.unit)(Yzmall_Page_CommodityInfo.component)(Data_Unit.unit)(Data_Void.absurd);
                      };
  ...
  exports["Navigate"] = Navigate;
  exports["component"] = component;
})(PS["Yzmall.Component.Router"] = PS["Yzmall.Component.Router"] || {});
(function(exports) {
  // Generated by purs version 0.12.1
  "use strict";
  var Affjax = PS["Affjax"];
  ...
  var Yzmall_Api_Request = PS["Yzmall.Api.Request"];
  var Yzmall_Api_Utils = PS["Yzmall.Api.Utils"];
  var Yzmall_AppM = PS["Yzmall.AppM"];
  var Yzmall_Capability_LogMessages = PS["Yzmall.Capability.LogMessages"];
  ...
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (v) {
      return Control_Bind.bind(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Effect_Ref["new"](Data_Maybe.Nothing.value)))(function (v1) {
          return Control_Bind.bind(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Routing_Hash.getHash))(function (v2) {
              ...
              var rootComponent = Halogen_Component.hoist(Halogen_HTML_Core.bifunctorHTML)(Effect_Aff.functorAff)(Yzmall_AppM.runAppM(environment))(Yzmall_Component_Router.component(Yzmall_AppM.monadAffAppM)(Yzmall_AppM.monadAskAppM(Type_Equality.refl))(Yzmall_AppM.nowAppM)(Yzmall_AppM.navigateAppM));
